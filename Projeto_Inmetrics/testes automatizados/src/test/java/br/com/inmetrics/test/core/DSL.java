...
import static br.com.inmetrics.test.core.DriverFactory.fecharDriver;
...
public class DSL {
	...
	public void scrollbarAteElemento(String xpath) {
		WebElement element = getDriver().findElement(By.xpath(xpath));
		executarJavascript("window.scrollBy(0, arguments[0])", element.getLocation().y);
	}
	
	public void validarConteudo(String xpath, String valor) {
		Assert.assertEquals(getDriver().findElement(By.xpath(xpath)).getText(), valor);
	}

	public void validarConteudoMensagem(String xpath, String valor) {
		String actualString = getDriver().findElement(By.xpath(xpath)).getText();
		Assert.assertTrue(actualString.contains(valor));
	}
	
	public void validarAusenciaConteudo(String xpath, String valor) {
		Assert.assertNotEquals(valor, getDriver().findElement(By.xpath(xpath)).getText());
	}
	...
	public DSL digitarSemEnter(String xpath, String texto) {
		WebElement elemento = encontrar(xpath);
		elemento.clear();
