...
public class StepDefinition {
	...
	@Quando("clico em excluir o primeiro funcionário da lista")
	public void clicoExcluirPrimeiroLista() {
		funcionariosPage.clicarExcluirPrimeiroLista();
	}
	
	@Quando("pesquiso pelo usuário cadastrado {string}")
	public void pesquisoUsuarioCadastrado(String nome) {
		funcionariosPage.pesquisarUsuarioCadastrado(nome);
	}
	
	@Quando("clico em editar o primeiro da lista")
	public void clicoEditarPrimeiroLista() {
		funcionariosPage.clicarEditarPrimeiroLista();
	}
	
	@Quando("altero o cargo para {string}")
	public void alteroCargo(String cargo) {
		funcionariosPage.alterarCargo(cargo);
	}
	
	@Então("salvo a alteração")
	public void salvoAlteracao() {
		funcionariosPage.salvarAlteracao();
	}
	...
	public void validoUsuarioNaoCadastrado() {
		cadastramentoUsuarioPage.validarUsuarioNaoCadastrado();
	}
}
